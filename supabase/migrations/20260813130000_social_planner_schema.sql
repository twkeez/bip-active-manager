...
-- is_active / verified / source_url are listed EXPLICITLY rather than relying on
-- column defaults, so these rows land dormant no matter what the defaults are.
insert into public.social_awareness_days
  (name, description, content_angle, rule_type, month, day, is_active, verified, source_url)
values
  ('National Train Your Dog Month', 'Whole month celebrating dog training', 'Share a quick training tip or highlight the importance of regular obedience work', 'month_long', 1, null, false, false, null),
  ('National Bird Day', 'Awareness day for pet birds and avian welfare', 'Feature any avian patients or share care tips for bird owners', 'fixed', 1, 5, false, false, null),
  ('National Walk Your Dog Week', 'First week of January — encourages daily dog walking', 'Motivate clients to start the year with a walking routine and why it matters for pet health', 'month_long', 1, null, false, false, null),
  ('National Pet Dental Health Month', 'Whole month focused on pet oral health', 'Share dental stats, before/after visuals (with permission), or a quick brushing demo video', 'month_long', 2, null, false, false, null),
  ('Valentine''s Day Pet Safety', 'Valentine''s Day — chocolate and lilies are hazards for pets', 'Warm love-themed post with a safety reminder about holiday hazards (chocolate, flowers)', 'fixed', 2, 14, false, false, null),
  ('Spay/Neuter Awareness Month', 'Whole month promoting spay and neuter', 'Share the health and population benefits of spay/neuter in an approachable way', 'month_long', 2, null, false, false, null),
  ('National Puppy Day', 'Celebrates puppies and promotes adoption', 'Feature a cute puppy patient or share new puppy tips — vaccines, socialization, first vet visit', 'fixed', 3, 23, false, false, null),
  ('National Pet Poison Prevention Week', 'Third week of March — common household toxins', 'Share a list of common household items that are toxic to pets — always high engagement', 'month_long', 3, null, false, false, null),
  ('St. Patrick''s Day Pet Safety', 'Holiday safety for pets', 'Fun green-themed post with a gentle reminder about alcohol and onion/garlic dangers', 'fixed', 3, 17, false, false, null),
  ('National Pet Day', 'Celebrates the joy pets bring to our lives', 'Ask followers to share a photo of their pet — great for comments and engagement', 'fixed', 4, 11, false, false, null),
  ('World Veterinary Day', 'Last Saturday in April — honors veterinary professionals worldwide', 'Celebrate the team! Group photo, individual spotlights, or thank-you post from the practice', 'month_long', 4, null, false, false, null),
  ('Prevention of Cruelty to Animals Month', 'ASPCA''s awareness month', 'Highlight the practice''s commitment to animal welfare or partner with a local shelter', 'month_long', 4, null, false, false, null),
  ('National Pet Month', 'US celebration of the human-animal bond', 'Feature heartwarming client stories or showcase the range of species the practice sees', 'month_long', 5, null, false, false, null),
  ('National Rescue Dog Day', 'Celebrates dogs rescued from shelters', 'Feature team members'' rescue pets or share a rescue patient success story', 'fixed', 5, 20, false, false, null),
  ('Chip Your Pet Month', 'Promotes microchipping for pet identification', 'Reminder post on why microchipping matters with a simple call-to-action to book the service', 'month_long', 5, null, false, false, null),
  ('National Microchipping Month', 'Dedicated month for microchip awareness', 'Share a reunited-with-owner story or explain how microchipping works in simple terms', 'month_long', 6, null, false, false, null),
  ('Adopt a Shelter Cat Month', 'Encourages cat adoption from shelters', 'Feature feline patients, share cat care tips, or partner with a local rescue', 'month_long', 6, null, false, false, null),
  ('National Pet Preparedness Month', 'Disaster preparedness for pet owners', 'Share a simple emergency kit checklist for pet owners — highly shareable practical content', 'month_long', 6, null, false, false, null),
  ('4th of July Pet Safety', 'Fireworks are highly stressful and dangerous for pets', 'Pre-holiday safety post: firework anxiety, ID tags, keeping pets indoors — always gets engagement', 'fixed', 7, 4, false, false, null),
  ('National Dog Photography Month', 'Celebrates pet photography', 'Share tips for getting a great photo of your dog at home — and ask clients to share their best shots', 'month_long', 7, null, false, false, null),
  ('National Lost Pet Prevention Month', 'Focuses on keeping pets safe and identified', 'Microchip reminder, ID tag check, and tips for keeping pets safely contained during summer', 'month_long', 7, null, false, false, null),
  ('International Cat Day', 'Global celebration of cats', 'Feature feline patients or share surprising cat health facts — great engagement day', 'fixed', 8, 8, false, false, null),
  ('National Check the Chip Day', 'Encourages pet owners to verify microchip registration', 'Reminder to check that microchip info is current — simple, actionable, easy to share', 'fixed', 8, 15, false, false, null),
  ('National Dog Day', 'Celebrates dogs and encourages adoption', 'Feature dog patients, ask followers to tag their dogs, or highlight canine care tips', 'fixed', 8, 26, false, false, null),
  ('National Responsible Dog Ownership Month', 'AKC month promoting responsible dog ownership', 'Share the pillars of responsible ownership: vet visits, training, nutrition, socialization', 'month_long', 9, null, false, false, null),
  ('Happy Cat Month', 'CFA''s month dedicated to feline health and happiness', 'Environmental enrichment tips, indoor cat wellness, or feature a senior cat patient', 'month_long', 9, null, false, false, null),
  ('Animal Pain Awareness Month', 'IVAPM awareness month for animal pain recognition', 'Educational post on subtle signs of pain in pets — a hugely valuable and shareable topic', 'month_long', 9, null, false, false, null),
  ('Adopt a Shelter Dog Month', 'ASPCA month encouraging dog adoption', 'Feature adopted patients or share the joys and tips of welcoming a rescue dog', 'month_long', 10, null, false, false, null),
  ('Pet Obesity Awareness Day', 'Second Wednesday of October', 'Share the risks of pet obesity and practical tips for healthy weight — pair with a body condition score visual', 'month_long', 10, null, false, false, null),
  ('Halloween Pet Safety', 'Candy and costumes pose hazards to pets', 'Pre-Halloween safety post: xylitol in candy, costume safety, keeping pets calm — always gets shares', 'fixed', 10, 31, false, false, null),
  ('National Cat Day', 'Celebrates cats and promotes adoption', 'Feature feline patients, fun cat facts, or ask followers to share their cats', 'fixed', 10, 29, false, false, null),
  ('Adopt a Senior Pet Month', 'ASPCA month dedicated to senior pet adoption', 'Feature a senior patient or highlight the rewards of adopting an older pet — deeply emotional content', 'month_long', 11, null, false, false, null),
  ('National Animal Shelter Appreciation Week', 'First full week of November', 'Thank local shelter staff or share how the practice supports the rescue community', 'month_long', 11, null, false, false, null),
  ('Thanksgiving Pet Safety', 'Thanksgiving food hazards for pets', 'Pre-holiday post on foods to keep away from pets — turkey bones, grapes, onions, xylitol', 'month_long', 11, null, false, false, null),
  ('National Cat Lovers Month', 'Whole month celebrating cats', 'Feature a feline patient each week or share a month-long series of cat care tips', 'month_long', 12, null, false, false, null),
  ('Holiday Pet Safety Month', 'Whole month — holiday hazards for pets', 'Decorations (tinsel, poinsettias), holiday food risks, travel tips — spread across multiple posts', 'month_long', 12, null, false, false, null),
  ('New Year''s Eve Pet Safety', 'Fireworks and celebrations can be stressful for pets', 'End-of-year post on helping pets through fireworks — links naturally to a January fresh-start post', 'fixed', 12, 31, false, false, null)
