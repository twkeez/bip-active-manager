...
import ContentLibraryEditor from "@/components/strategy-mapper/content-library-editor";
import { createClient } from "@/lib/supabase/server";
import { redirect } from "next/navigation";

export default async function StrategyMapperContentLibraryPage() {
    ...
    <div className="min-h-screen bg-bip-page font-sans text-bip-text">
      ...
      <div className="px-4 py-10 sm:px-6">
        ...
        <div className="mx-auto max-w-4xl">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-bip-text">Report Content Library</h1>
            <p className="mt-2 text-sm text-bip-muted">
              Manage executive summary, keyword matrix, launch roadmap, and Phase 2 upsell
              templates for the Onboarding Strategy Mapper.
            </p>
          </div>
