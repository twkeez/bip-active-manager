...
function snapshotToSyncResult(snapshot: AdsSnapshot): AdsSyncResult {
  return {
    ...
    totals: {
      ...
      all_conversions: snapshot.totals.all_conversions ?? 0,
      view_through_conversions: snapshot.totals.view_through_conversions ?? 0,
      conversions_value: snapshot.totals.conversions_value ?? 0,
      ctr: snapshot.totals.ctr,
      average_cpc: snapshot.totals.average_cpc,
      conversion_rate: snapshot.totals.conversion_rate ?? null,
      cost_per_conversion: snapshot.totals.cost_per_conversion ?? null,
      roas: snapshot.totals.roas ?? null,
      search_impression_share: snapshot.totals.search_impression_share ?? null,
      search_rank_lost_impression_share: snapshot.totals.search_rank_lost_impression_share ?? null,
      search_budget_lost_impression_share: snapshot.totals.search_budget_lost_impression_share ?? null,
      search_top_impression_share: snapshot.totals.search_top_impression_share ?? null,
      search_absolute_top_impression_share: snapshot.totals.search_absolute_top_impression_share ?? null,
    },
    campaigns: snapshot.campaigns.map((campaign) => ({
      ...
      interactions: campaign.interactions ?? 0,
      cost_micros: campaign.cost_micros,
      conversions: campaign.conversions,
      all_conversions: campaign.all_conversions ?? 0,
      view_through_conversions: campaign.view_through_conversions ?? 0,
      conversions_value: campaign.conversions_value ?? 0,
      ctr: campaign.ctr,
      ...
      search_top_impression_share: campaign.search_top_impression_share ?? null,
      search_absolute_top_impression_share: campaign.search_absolute_top_impression_share ?? null,
    })),
